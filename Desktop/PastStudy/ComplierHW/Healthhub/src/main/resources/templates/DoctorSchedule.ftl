...
<#list workinfs as workinf><form name="frmLogin" action="/calendar/Delete">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="panel panel-success">
            <div class="panel-heading">

                <h3 class="panel-title"><i class="fa fa-users"></i>${workinf.data}</h3>
            </div>
            <table class="table table-striped">
                <thead>
                    ...
                    <tbody>
                    <input type="hidden" name="data" value="${workinf.data}" />
                    <#list workinf.arraylist as dailyinf>
                    <input type="hidden" name="ID" value="${workinf.doctorid}" />
                        <tr>
                        <td>${dailyinf.userid} </td>
                        <td>${dailyinf.comment}</td>
                        <td>${dailyinf.place} </td>
                    </#list>
