                ...
                <table class="table table-striped">
                    ...
                    <#list appointmentlist as appointment>
                        <tr><#if appointment.orderquantity lte 12>
                                <form name="frmLogin" action="/orders/hygienist/id" method="post">
                                    <td>${appointment.data}</td>
                                    <td>${appointment.orderquantity}</td>
                                    <td> <select>
                                        <option value="mary">mary</option>
                                        <option value="sara">Saab</option>
                                        </select></td>
                                    <td><input type="text" name="comment" /></td>
                                    <input type="hidden" name="data" value="${appointment.data}" />
                                    <input type="hidden" name="doctorid" value="${appointment.hygienist}" />
