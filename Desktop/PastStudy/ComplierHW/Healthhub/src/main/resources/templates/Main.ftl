...
<#--                       <img src="/upload/imgs/test.jpg" alt="logo">-->
    ...
    $(function(){
        ...
        for (var i=0;i<blogs.length;i++){
            var html = " <div class=\"panel panel-default\">\n" +
                ...
                "                                        <button class=\"btn-danger btn-sm\" onclick='s("+blogs[i].disid+")' data-toggle=\"modal\" data-target=\"#reply\">cite</button>\n" +
            // onclick='cite("+blogs[i].disid+")'
                "                                    </div>" +
                "                                    </div>\n" +
                "                                </div>";
            $("#context").append(html);
