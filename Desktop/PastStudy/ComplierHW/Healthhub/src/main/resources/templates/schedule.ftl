...
<html>
    ...
    <div class="content-container wrap">
        ...
        <div class="container-fluid">
            ...
            <form name="frmLogin" action="/calendar">
                <br>
                Please select the doctor work on Monday:
                ...
                <br>
                Please select the doctor work on Tuesday:
                ...
                <br>
                Please select the doctor work on wednesday:
                ...
                <br>
                Please select the doctor work on Thursday:
                ...
                <br>
                Please select the doctor work on Friday:
                ...
                <br>
                Please select the doctor work on Saturday:
                ...
                <br>
                Please select the doctor work on Sunday:
